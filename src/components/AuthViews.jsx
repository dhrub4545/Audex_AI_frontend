        ...
        <div className="auth-left">
          ...
          <div className="auth-content-group">
            ...
            <div className="auth-social-row">
              <button type="button" onClick={() => window.location.href = `${API_BASE_URL}/auth/google`} className="auth-social-btn">
              ...
              <button type="button" onClick={() => window.location.href = `${API_BASE_URL}/auth/github`} className="auth-social-btn">
